"""
Fixed Telegram OTP Authentication using Telethon client.
Proper implementation without LSP errors.
"""
import asyncio
import os
        ...
        try:
            ...
            if not db_user:
                ...
                if telegram_account:
                    ...
                    telegram_account.session_data = session_string
